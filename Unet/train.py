...
train_ds = LaneDetectionDataset(image_paths=train_images, mask_paths=train_masks, transforms=transforms)
test_ds = LaneDetectionDataset(image_paths=test_images, mask_paths=test_masks, transforms=transforms)
...
end_time = time.time()
print("[INFO] total time taken to trian the model: {:.2f}s".format(end_time-start_time))
