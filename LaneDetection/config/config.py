...
# PRE_TRAINED_WEIGHTS_PATH = os.path.join(BASE_OUTPUT, "enet_102_200.pth.tar")
PRE_TRAINED_WEIGHTS_PATH = os.path.join(BASE_OUTPUT, "enet_130_80.pth.tar")
MODEL_PATH = os.path.join(BASE_OUTPUT, "enet_weights.pth.tar")
